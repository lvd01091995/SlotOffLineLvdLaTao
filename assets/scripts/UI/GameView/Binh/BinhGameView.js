...
var BinhGamView = cc.Class({
    ...
    showExchangeMoney() {
        ...
        for (let i = 0; i < this.players.length; i++) {
            ...
            //     {
            //         _chatHistory->addTextChat(StringUtils::format(CCFS("binh_you_lost"), player->mauBinh_M), "Monica");
            //         _quickChat->onShowChatText("Monica", StringUtils::format(CCFS("shan2_you_lost"), player->mauBinh_M));
            //     }
            //     else
            //     {
            //         _chatHistory->addTextChat(StringUtils::format(CCFS("shan2_you_win"), player->mauBinh_M), "Monica");
            //         _quickChat->onShowChatText("Monica", StringUtils::format(CCFS("shan2_you_win"), player->mauBinh_M));
            //     }
            // }
