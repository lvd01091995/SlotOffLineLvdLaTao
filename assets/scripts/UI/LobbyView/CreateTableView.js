...
var CreateTableView = cc.Class({
    ...
    init: function() {
        ...
        this.cur_per = Math.round(9 / Global.LobbyView.ltv_data_list.length * 100) / 1000;
    ...
    handleSlide() {
        ...
        this.cur_index = Math.min(this.cur_index, Global.LobbyView.ltv_data_list.length - 1);
        this.cur_index = Math.round(this.cur_index);
        
        this.lb_curBet.string = GameManager.formatMoney(Global.LobbyView.ltv_data_list[this.cur_index].mark);
