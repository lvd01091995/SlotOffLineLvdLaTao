...
cc.Class({
    ...
    isnomal() {
        ...
        this.lb_cur_user.node.setPosition(-18, -56);
        this.ic_user.node.setPosition(-39, -56);
    ...
    isVip(indexSpr) {
        ...
        this.lb_cur_user.node.setPosition(-5, -43);
        this.ic_user.node.setPosition(-26, -43);
        this.lb_cur_user.node.color = new cc.Color(25, 11, 124);
        this.ic_user.node.color = new cc.Color(25, 11, 124);
        this.lb_mark.node.setPosition(-2, 15);
        this.sp_best_choise.node.active = false;
        this.ic_best.node.active = false;
    },
    onClickChoose() {
